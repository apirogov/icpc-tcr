...
\subsection{Ausgabeformatierung mit \texttt{DecimalFormat}}
\begin{tabular}{cl}
...
\includepdf[pages=-,clip,trim=6mm 6mm 6mm 1.8cm,scale=0.95,pagecommand={\pagestyle{plain}}]{tcs-cheat-sheet.pdf}
